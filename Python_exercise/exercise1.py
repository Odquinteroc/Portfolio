...
def maxProfit(prices: list[int]) -> int:
    # Si la lista de precios está vacía o tiene un solo elemento, no se puede obtener ninguna ganancia
    if not prices or len(prices) < 2:
        return 0
    max_profit = 0
    # Recorre cada par de días y calcula la ganancia si se compra en el día i y se vende en el día j
